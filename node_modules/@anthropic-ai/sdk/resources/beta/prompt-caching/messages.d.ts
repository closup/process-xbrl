...
export declare class Messages extends APIResource {
     ...
     * conversations.
     */
    create(params: MessageCreateParamsNonStreaming, options?: Core.RequestOptions): APIPromise<PromptCachingBetaMessage>;
    create(params: MessageCreateParamsStreaming, options?: Core.RequestOptions): APIPromise<Stream<RawPromptCachingBetaMessageStreamEvent>>;
    create(params: MessageCreateParamsBase, options?: Core.RequestOptions): APIPromise<Stream<RawPromptCachingBetaMessageStreamEvent> | PromptCachingBetaMessage>;
    /**
